...
یک بسته ساده برای اجرای مایگریشن های دیتابیس PostgreSQL با استفاده از `golang-migrate`.

## امکانات

- اجرای مایگریشن ها با `up`
- بازگرداندن مایگریشن ها با `down`
- تنظیم نسخه با `force`
...
همچنین مسیر فایل‌های مایگریشن را می‌توان با `MIGRATIONS_PATH` مشخص کرد.
